...
//  LearnMetal
//
//  Created by Renjun Li on 2022/5/22.
...
@interface HAHAViewController () <MTKViewDelegate>
...
- (void)viewDidLoad {
    ...
    slider.frame = CGRectMake(0, UIScreen.mainScreen.bounds.size.height - 100, UIScreen.mainScreen.bounds.size.width, 20);
...
-(void)setupPipeline {
    ...
    id<MTLFunction> vertexFunction = [defaultLibrary newFunctionWithName:@"hahaVertexShader"]; // 顶点shader，vertexShader是函数名
    id<MTLFunction> fragmentFunction = [defaultLibrary newFunctionWithName:@"hahaSamplingShader"]; // 片元shader，samplingShader是函数名
...
- (void)drawInMTKView:(MTKView *)view {
    ...
    if(renderPassDescriptor != nil)
    {
        ...
        [renderEncoder setVertexBytes:&_radius length:sizeof(_radius) atIndex:1];
