...
- (void)setupPipeline {
    ...
    id<MTLFunction> vertexFunction = [defaultLibrary newFunctionWithName:@"sobelVertexShader"]; // 顶点shader，vertexShader是函数名
    id<MTLFunction> fragmentFunction = [defaultLibrary newFunctionWithName:@"sobelSamplingShader"]; // 片元shader，samplingShader是函数名
